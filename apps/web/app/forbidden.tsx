...
// only caller is the insiders surface (spec 0035), reached by a signed-in account that is not an
...
export default function Forbidden() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-4 bg-bg px-6 text-center text-text">
      ...
      <h1 className="text-h2 text-text">Insiders only</h1>
      <p className="text-body text-text-muted max-w-md">
        Your account does not have access to this surface yet. If you think that is a mistake, reach
        out and we will get you in.
      </p>
      <a
        href="/"
