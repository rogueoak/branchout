...
describe('InsiderHome (spec 0035)', () => {
  ...
  it('offers a "Play now" CTA on the Teeter Tower card (feedback 0030)', () => {
    render(<InsiderHome viewer={viewer} surface={surface} />);
    // A visible "Play now" affordance sits within each insider game card link. With more than one
    // insider game listed there are several; the Teeter card is identified by its accessible name.
