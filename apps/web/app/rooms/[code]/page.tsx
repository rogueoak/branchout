...
// server-side so the shared top nav (spec 0029) renders without an auth flash in the lobby/setup.
// The surface (feedback 0029) is read from the host so the picker offers insider-only games only on
