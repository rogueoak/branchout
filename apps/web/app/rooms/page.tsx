...
// read server-side so the shared top nav (spec 0029) renders without an auth flash. The surface
// (feedback 0029) is read from the host so this one page serves both the apex and the insider
