...
- **Would reject** - being forced to create an account just to join; a join flow longer than
  a room code; unclear whose turn it is or how to act; credits running out with no warning;
  competing calls to action; anything that feels like a spreadsheet instead of a game.
